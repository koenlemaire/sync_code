function [statedot,output]=frwd_jumper_flight(t,state,parms)
%
...
k=0; b=0; % damping and stiffness to make body straight 
phiJo=phi(2:end)-phi(1:end-1);
phidJo=phid(2:end)-phid(1:end-1);
Mjo=[0 -k*phiJo'-b*phidJo' 0];
...
K=...
    [1 0 0 0 1 ...% Frx (n+1)
     ...
     0 0 ];% basedd (2)
V=...
    [0 nan nan nan 0 ...% Frx (n+1)
     0 nan nan nan 0 ...% Fry (n+1)
